...
## Prerequisite
Verilog syntax highlight is not natiavely supported for Sublime Text.
...
This way does not use the `` `include`` syntax in "xxx_t.v" but combines files in the command line.
